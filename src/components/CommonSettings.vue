  ...
  <div class="glass p-6 space-y-6">
    ...
    <div class="space-y-3">
      <div class="flex justify-between items-center">
        <label class="text-sm text-gray-300">{{ $t('settings.temperature.label') }}</label>
        <div class="flex items-center gap-2">
          <span class="text-xs px-2 py-1 rounded-md bg-blue-500/20 text-blue-300">
            {{ temperatureLabel }}
          </span>
    ...
    <div class="space-y-3">
      <div class="flex justify-between items-center">
        <label class="text-sm text-gray-300">{{ $t('settings.seed.label') }}</label>
        <button
          v-if="store.seed"
          @click="store.seed = ''"
